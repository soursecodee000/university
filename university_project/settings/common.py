...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'university_project', 'staticfiles')  # Corrected path for staticfiles
STATICFILES_DIRS = [
    os.path.join(MAIN_DIR, 'static'),  # Ensure this points to the correct path
]
